...
function XmlElement(tag) {
  ...
  this.startElementPosition = parser.startTagPosition;

  last_close_position = parser.position;
}
...
XmlElement.prototype._closetag = function() {
  ...
  this.endElementPosition = parser.position;
...
function XmlTextNode (text) {
  ...
  this.position = parser.startTagPosition - 1;
  this.endElementPosition = this.position;
  this.startElementPosition = last_close_position + 1;
  this.text = text;
}
